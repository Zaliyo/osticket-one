        ...
        <form action="tickets.php" method="get" id="ticketSearchForm">
            <div class="form-row align-items-center">
                <div class="col-auto">
                    ...
                    <input type="text" class="form-control mb-2" name="keywords" id="inlineFormInput"
                ...
                <div class="col-auto">
                    ...
                    <div class="input-group mb-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text"><?php echo __('Help Topic'); ?>:</div>
                        </div>
                ...
                <div class="col-auto">
                    <button type="submit" class="btn btn-primary mb-2" value="<?php echo __('Search'); ?>"><i
                                class="fas fa-search-plus"></i> Search
                    </button>
                </div>
                <div class="col-auto">
                    <?php if ($settings['keywords'] || $settings['topic_id'] || $_REQUEST['sort']) { ?>
                        <div>
                            <a class="btn btn-outline-danger mb-2" href="?clear">
    ...
    <tr>
        <th nowrap>
            <a href="tickets.php?sort=ID&order=<?php echo $negorder; ?><?php echo $qstr; ?>"
               title="Sort By Ticket ID"><?php echo __('Ticket #'); ?>&nbsp;<i class="icon-sort"></i></a>
        </th>
        <th width="120">
            <a href="tickets.php?sort=date&order=<?php echo $negorder; ?><?php echo $qstr; ?>"
               title="Sort By Date"><?php echo __('Create Date'); ?>&nbsp;<i class="icon-sort"></i></a>
        </th>
        <th width="100">
            <a href="tickets.php?sort=status&order=<?php echo $negorder; ?><?php echo $qstr; ?>"
               title="Sort By Status"><?php echo __('Status'); ?>&nbsp;<i class="icon-sort"></i></a>
        </th>
        <th width="320">
            <a href="tickets.php?sort=subject&order=<?php echo $negorder; ?><?php echo $qstr; ?>"
               title="Sort By Subject"><?php echo __('Subject'); ?>&nbsp;<i class="icon-sort"></i></a>
        </th>
        <th width="120">
            <a href="tickets.php?sort=dept&order=<?php echo $negorder; ?><?php echo $qstr; ?>"
               title="Sort By Department"><?php echo __('Department'); ?>&nbsp;<i class="icon-sort"></i></a>
        </th>
    </tr>
    </thead>
    <tbody>
